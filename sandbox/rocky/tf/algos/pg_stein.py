...
class PGStein(BatchPolopt, Serializable):
    ...
    def __init__(
        ...
        self.opt_info = None
        super(PGStein, self).__init__(env=env, policy=policy, baseline=baseline, **kwargs)
    ...
    def init_opt(self):
        ...
        self.optimizer.update_opt(loss=surr_obj, target=self.policy,
                logstd=log_std_var, inputs=input_list)
